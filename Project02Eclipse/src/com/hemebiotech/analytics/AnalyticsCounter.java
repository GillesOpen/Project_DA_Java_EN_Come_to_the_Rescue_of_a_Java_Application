...
public class AnalyticsCounter {
	...
	public static void main(String[] args) {
		...
		// ajoutés et supprimés à tout moment.
		...
		// classe sont triés par clé dans l'ordre croissant.
		// changement du fichier en sortie
		...
		// traitement de lecture du fichier en entrée appel de méthode getSymptoms()
